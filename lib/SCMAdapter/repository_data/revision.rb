...
module SCMAdapter
  module RepositoryData
    class Revision
      attr_accessor :identifier, :author, :time, :parents_identifier, :message, :files

      # @param [String] identifier
      # @param [Author] author : the author of the commit.
      # @param [Time] Time : commit date.
      # @param [Array] parents_identifier : an array of string containing
      # parent identifier.
      ...
      def initialize(identifier, author, time, parents_identifier, message, files)
        @identifier = identifier #Sha for git or hg, commit number for svn.
        @author = author
        @time = time
        @parents_identifier = parents_identifier
        @message = message
        @files = files
      end
    end
